...
void ot_spi_device_qp_set_settle_hook(DeviceState *dev, int (*fn)(void *), void *ctx)
{
    OT_SPI_DEVICE_QP(dev)->core._qp_settle_hook = fn;
    OT_SPI_DEVICE_QP(dev)->core._qp_settle_hook_ctx = ctx;
}
